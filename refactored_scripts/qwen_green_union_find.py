...
class Union:
    ...
    def add(self, element: object) -> None:
        ...
        """
        # Only add if element doesn't already exist
    ...
    def root(self, element: object) -> object:
        ...
        """
        # Path compression - iterative approach for better performance
        root = element
        # Find the root
    ...
    def unite(self, element1: object, element2: object) -> None:
        ...
        """
        # Early exit if elements are the same
        ...
        # Union by size - ensure root2 is the larger set
