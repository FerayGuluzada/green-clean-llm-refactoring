...
def _build_segment_tree_functions(tree: list[int], size: int):
    """Create update and query functions for a segment tree."""
...
def longest_increasing_subsequence_optimized(sequence: list[int]) -> int:
    ...
    tree = [0] * (max_val * 4)
    _update, _get_max = _build_segment_tree_functions(tree, max_val)
...
def longest_increasing_subsequence_optimized2(sequence: list[int]) -> int:
    ...
    _update, _get_max = _build_segment_tree_functions(tree, length)
