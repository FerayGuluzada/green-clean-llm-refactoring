...
def max_flow(capacity, source, sink, algorithm="dinic"):
    """
    Computes maximum flow from source to sink using the specified algorithm.
    """
    vertices = len(capacity)
...
if __name__ == "__main__":
    ...
    print(max_flow(capacity, source, sink, "ford_fulkerson"))
    print(max_flow(capacity, source, sink, "edmonds_karp"))
    print(max_flow(capacity, source, sink, "dinic"))