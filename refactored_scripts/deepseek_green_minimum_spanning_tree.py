...
class DisjointSet:
    def __init__(self, n):
        ...
        self.parent = list(range(n))  # Direct initialization without extra loop
    ...
    def mergeSet(self, a, b):
        ...
        if self.size[a] < self.size[b]:
            a, b = b, a  # Swap to always merge smaller into larger
    ...
    def findSet(self, a):
        parent = self.parent
        # Path compression with iterative approach
        root = a
